import puzzleData from "./puzzle_data.json";
...
class PuzzleManager {
  ...
  private constructor() {
    this.puzzleData = puzzleData as PuzzleData;
  ...
  public static getInstance(): PuzzleManager {
...
export const getPuzzleManager = (): PuzzleManager => {
  return PuzzleManager.getInstance();
};
